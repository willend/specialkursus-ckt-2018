function [] = AsymmetricRowland_NewGeometry(En, width, L1, L2, delta, Nbla, Qflag)
close all;
...
Wbla = floor(Segleng); % Width of the blades
...
set(gca, 'ylim', [-80 80])
title(['Analyzer @ E_f = ' num2str(En, 3) ' meV'], 'fontname', 'times', 'fontsize', 15);
set(gca, 'fontname', 'times', 'fontsize', 10);
xlabel('Horizontal x-axis (along Q-channel) [mm]', 'fontname',  'times', 'fontsize', 12);
ylabel('Vertical z-axis [mm]',  'fontname', 'times', 'fontsize', 12);
...
widbla = floor(Wbla*10)/10; %Calculating the width of each blade
...
%save 'AnaData_2p7.mat' A_a5 xA yA width
    ...
    fprintf(fid, ['Width of each blade: ' num2str(widbla) ' mm \n']);
